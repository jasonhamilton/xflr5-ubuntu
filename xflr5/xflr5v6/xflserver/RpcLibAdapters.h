...
{   
    // public:
        ...
        struct PolarResultAdapter{
            ...
            PolarResultAdapter(){}
            PolarResultAdapter(const Polar& out, const std::vector<enumPolarResult>& result_list = std::vector<enumPolarResult>{}){
        ...
        struct WPolarResult{
            ...
            WPolarResult(){}
            WPolarResult(const WPolar& out, const std::vector<enumWPolarResult>& result_list = std::vector<enumWPolarResult>{}){
                if (result_list.size()==0) return;
                for (auto const& key: result_list){ //iterating once to avoid using find at every comparison
                    switch (key)
                    {
